...
atlas-algo-sort-scope is a OCaml project for algorithms. It focuses on this technical goal: Package an OCaml local lab for sort analysis with node-edge fixtures, cycle and reachability reports, and documented operating limits.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 150, risk penalty 6, latency penalty 2, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
