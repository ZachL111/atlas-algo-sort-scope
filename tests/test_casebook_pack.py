"""Regression checks for the atlas-algo-sort-scope casebook."""
...
from casebook.harness import assert_expected, atlas_algo_sort_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(atlas_algo_sort_scope_summary(), assert_expected())
